    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalConclusions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicalConclusions_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicalConclusions_PatientCards_PatientCardId",
                        column: x => x.PatientCardId,
                        principalTable: "PatientCards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicalConclusions_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalConclusions_DoctorId",
                table: "MedicalConclusions",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalConclusions_PatientCardId",
                table: "MedicalConclusions",
                column: "PatientCardId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalConclusions_PatientId",
                table: "MedicalConclusions",
                column: "PatientId");
